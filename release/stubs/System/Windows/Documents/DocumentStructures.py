...
class FigureStructure(
    SemanticBasicElement, IAddChild, IEnumerable[NamedElement], IEnumerable
):
    """
...
class ListItemStructure(
    SemanticBasicElement, IAddChild, IEnumerable[BlockElement], IEnumerable
):
    """
...
class ListStructure(
    SemanticBasicElement, IAddChild, IEnumerable[ListItemStructure], IEnumerable
):
    """
...
class TableRowGroupStructure(
    SemanticBasicElement, IAddChild, IEnumerable[TableRowStructure], IEnumerable
):
    """
...
class TableRowStructure(
    SemanticBasicElement, IAddChild, IEnumerable[TableCellStructure], IEnumerable
):
    """
...
class TableStructure(
    SemanticBasicElement, IAddChild, IEnumerable[TableRowGroupStructure], IEnumerable
):
    """
