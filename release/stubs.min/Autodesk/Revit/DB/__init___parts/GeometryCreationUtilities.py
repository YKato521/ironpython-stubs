class GeometryCreationUtilities(object):
  ...
  """
    ...
    @staticmethod
    def CreateExtrusionGeometry(
        profileLoops, extrusionDir, extrusionDist, solidOptions=None
    ):
        """
  ...
  """
    ...
    @staticmethod
    def CreateFixedReferenceSweptGeometry(
        sweepPath,
  ...
  """
    ...
    @staticmethod
    def CreateRevolvedGeometry(
        coordinateFrame, profileLoops, startAngle, endAngle, solidOptions=None
    ):
        """
  ...
  """
    ...
    @staticmethod
    def CreateSweptBlendGeometry(
        pathCurve, pathParams, profileLoops, vertexPairs, solidOptions=None
    ):
        """
