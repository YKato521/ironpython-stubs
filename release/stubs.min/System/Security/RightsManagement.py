...
"""
    ...
    UseLicenseAcquisitionUrl = property(
        lambda self: object(), lambda self, v: None, lambda self: None
    )
...
"""
    ...
    LocalizedNameDescriptionDictionary = property(
        lambda self: object(), lambda self, v: None, lambda self: None
    )
